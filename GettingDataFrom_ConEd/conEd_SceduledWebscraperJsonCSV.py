...
def WebscraperJsonToCSV():  
    ...
    try:
        ...
        print("Couldnt get the json data so will re-run function and try to print errors. This is Run "+ str(scrapingCount))
        try:
            errort = 'PRINTING ERRORS:'
            try:
                errort+=" html_data"
...
scheduler.add_job(WebscraperJsonToCSV, 'interval', seconds=3)
scheduler.start()
